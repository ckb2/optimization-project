...
nutr1<-read_delim("OptimizationModel_Household1/data_nutrients.csv")
nutr2<-read_delim("OptimizationModel_Household2/data_nutrients.csv")
nutr3<-read_delim("OptimizationModel_Household3/data_nutrients.csv")
nutr4<-read_delim("OptimizationModel_Household4/data_nutrients.csv")
